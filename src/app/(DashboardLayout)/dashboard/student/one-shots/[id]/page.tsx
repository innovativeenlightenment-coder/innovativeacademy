...
export default async function OneShotPage({
  ...
  const video = await getOneShot(id);

  if (!video || video.type !== "oneShot") {
    return (
        ...
        <div className="mt-6 overflow-hidden rounded-3xl border border-gray-200/80 bg-white shadow-[0_10px_40px_rgba(0,0,0,0.06)]">
          ...
          <div className="p-5 sm:p-7 lg:p-8">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="inline-flex items-center gap-2 rounded-full border border-purple-100 bg-purple-50 px-3.5 py-1.5 text-xs font-bold text-purple-700">
          ...
          <div className="flex flex-col gap-4 border-t border-gray-100 p-5 sm:flex-row sm:items-center sm:justify-between sm:p-7">
            ...
            <div>
              ...
              <p className="mt-1 text-sm font-medium text-gray-700">
                Revise the complete chapter and strengthen your concepts.
              </p>
            </div>
