...
//    const res = await fetch("/api/teacher-exam/create", {
//   method: "POST",
//   headers: { "Content-Type": "application/json" },
//   body: JSON.stringify({
//     testType,          // "monthly" | "quarterly"
//     teacherName: name, // your teacher select
//     startTime,         // ISO string (we’ll build it from date + time)
//     endTime,           // ISO string
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={6}>
              <TextField
                ...
                value={formatDuration(selectedIds.length * secondsPerQuestion)}
                InputProps={{ readOnly: true }}
                fullWidth
              />
            </Grid>
