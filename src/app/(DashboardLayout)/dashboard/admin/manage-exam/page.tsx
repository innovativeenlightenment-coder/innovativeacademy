...
const getAverageSecondsPerQuestion = (
  secondsPerQuestion: TeacherExam["secondsPerQuestion"]
) =>
  (secondsPerQuestion.easy +
    secondsPerQuestion.moderate +
    secondsPerQuestion.difficult +
    secondsPerQuestion.extreme) /
  4;
              ...
              <TextField
                ...
                value={formatDuration(
                  (editingExam?.totalQuestions ?? 0) *
                    getAverageSecondsPerQuestion(
                      editingExam?.secondsPerQuestion ?? {
                        easy: 20,
  moderate: 35,
  difficult: 60,
  extreme: 90,
