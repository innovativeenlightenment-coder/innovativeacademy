            ...
            <div className="hidden md:block md:max-w-2/5">
              <div className="relative">
                ...
                <div className="relative bg-white rounded-3xl border-2 border-purple-200 p-6 shadow-2xl">
                  ...
                  "My mission is to help each students imporve, grow, and excel not only in exams but in life..."
                </p>
...
{/* 
      ...
      <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-slate-600 text-center mb-16 text-lg">Have questions? We'd love to hear from you!</p>
